...
-(void)pressesBegan:(NSSet<UIPress *> *)presses withEvent:(UIPressesEvent *)event {
    ...
    if (press)
    {
        UnitySendMessage("ExternalInputController", "DidBeginPressForKey", [press.key.characters UTF8String]);
    }
    else
    {
...
-(void)pressesEnded:(NSSet<UIPress *> *)presses withEvent:(UIPressesEvent *)event {
    ...
    if (press)
    {
        UnitySendMessage("ExternalInputController", "DidEndPressForKey", [press.key.characters UTF8String]);
    }
    else
    {
...
-(void)pressesChanged:(NSSet<UIPress *> *)presses withEvent:(UIPressesEvent *)event {
    ...
    if (press)
    {
        UnitySendMessage("ExternalInputController", "DidChangePressForKey", [press.key.characters UTF8String]);
        UnitySendMessage("ExternalInputController", "DidReceiveForceValue", [[NSString stringWithFormat:@"%f", press.force] UTF8String]);
    }
    else
    {
...
-(void)pressesCancelled:(NSSet<UIPress *> *)presses withEvent:(UIPressesEvent *)event {
    ...
    if (press)
    {
        UnitySendMessage("ExternalInputController", "DidCancelPressForKey", [press.key.characters UTF8String]);
    }
    else
    {
